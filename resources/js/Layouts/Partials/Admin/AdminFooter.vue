...
<p class="my-10 text-sm text-center text-gray-500" x-data="{ year: new Date().getFullYear() }">
    &copy; 2024-<span x-text="year"></span> <a href="https://runacode.dev" class="text-blue-600 underline dark:text-blue-500 hover:no-underline">runacode.dev</a>. Todos los derechos reservados.
</p>
