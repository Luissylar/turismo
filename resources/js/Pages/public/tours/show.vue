            ...
            <div class="relative flex items-center justify-center text-white bg-center bg-no-repeat bg-cover"
                ...
                <div class="z-10 flex flex-col items-center justify-center p-4 text-center">
                    ...
                    <h1
                        ...
                        <span
                            class="underline underline-offset-3 decoration-8 decoration-blue-400 dark:decoration-blue-600">SHOW TOURS</span>
                    </h1>
                        ...
                        <div class="py-10 text-center rounded-2xl bg-gray-50 ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
                            <div class="max-w-xs px-8 mx-auto">
                                ...
                                <p class="flex items-baseline justify-center mt-6 gap-x-2">
                                    <span class="text-5xl font-bold tracking-tight text-gray-900">${{ props.tour.precio }}</span>
