...
const breadcrumbs = [
    ...
    { name: 'admin.setting', label: 'Configuraciones' }
        ...
        <main>
            ...
            <div class="grid grid-cols-1 px-4 pt-6 xl:grid-cols-3 xl:gap-4 dark:bg-gray-900">
                <div class="mb-4 col-span-full xl:mb-2">
                    ...
                    <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Configuración general
                    </h1>
                </div>
                <!-- Right Content -->
                <div class="col-span-full xl:col-auto">
                    <div class="p-4 mb-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 dark:bg-gray-800">
                        <div class="items-center sm:flex xl:block 2xl:flex sm:space-x-4 xl:space-x-0 2xl:space-x-4">
                            ...
                            <div>
                                <h3 class="mb-1 text-2xl font-bold text-gray-900 dark:text-white">Nombre de la empresa
                                </h3>
                                <div class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">
                                    no se pero colocar algo
                                </div>
                                <a href="#"
                    ...
                    <div class="p-4 mb-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 dark:bg-gray-800">
                        ...
                        <div class="mb-4">
                            <label for="settings-language"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Modena de cobro principal</label>
                            <select id="settings-language" name="countries"
                                class="bg-gray-50 border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                <option>Soles</option>
                    ...
                    <div class="p-4 mb-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 dark:bg-gray-800">
                        <div class="flow-root">
                            <h3 class="text-xl font-bold dark:text-white">Redes sociales</h3>
                    ...
                    <div class="p-4 mb-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 dark:bg-gray-800">
                        <div class="flow-root">
                            <h3 class="text-xl font-bold dark:text-white">Personal de la empresa</h3>
                            <ul class="mb-6 divide-y divide-gray-200 dark:divide-gray-700">
                                <li class="py-4">
                                    <div class="flex justify-between xl:block 2xl:flex align-center 2xl:space-x-4">
                                        <div class="flex space-x-4 xl:mb-4 2xl:mb-0">
                                            <div>
                                                <img class="w-6 h-6 rounded-full" src="" alt="Bonnie image">
                                            </div>
                                            <div class="flex-1 min-w-0">
                                                <p
                                ...
                                <li class="py-4">
                                    <div class="flex justify-between xl:block 2xl:flex align-center 2xl:space-x-4">
                                        <div class="flex space-x-4 xl:mb-4 2xl:mb-0">
                                            <div>
                                                <img class="w-6 h-6 rounded-full" src="" alt="Jese image">
                                            </div>
                                            <div class="flex-1 min-w-0">
                                                <p
                                                    class="text-base font-semibold text-gray-900 leading-none truncate mb-0.5 dark:text-white">
                                ...
                                <li class="py-4">
                                    <div class="flex justify-between xl:block 2xl:flex align-center 2xl:space-x-4">
                                        <div class="flex space-x-4 xl:mb-4 2xl:mb-0">
                                            <div>
                                                <img class="w-6 h-6 rounded-full" src="" alt="Thomas image">
                                            </div>
                                            <div class="flex-1 min-w-0">
                                                <p
                                                    class="text-base font-semibold text-gray-900 leading-none truncate mb-0.5 dark:text-white">
                                ...
                                <li class="pt-4">
                                    <div class="flex justify-between xl:block 2xl:flex align-center 2xl:space-x-4">
                                        <div class="flex space-x-4 xl:mb-4 2xl:mb-0">
                                            <div>
                                                <img class="w-6 h-6 rounded-full" src="" alt="Lana image">
                                            </div>
                                            <div class="flex-1 min-w-0">
                                                <p
                                                    class="text-base font-semibold text-gray-900 leading-none truncate mb-0.5 dark:text-white">
                ...
                <div class="col-span-2">
                    ...
                    <div class="p-4 mb-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 dark:bg-gray-800">
                        <h3 class="mb-4 text-xl font-bold dark:text-white">Colocar acá los horarios de atencion,
                            precencial y virtual</h3>
                        <form action="#">
                            <div class="grid grid-cols-6 gap-6">
                                <!-- Empezar desde acá -->
                    ...
                    <div class="p-4 mb-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 dark:bg-gray-800">
                        <h3 class="mb-4 text-xl font-bold dark:text-white">DIRECCION DE LA EMPRESA</h3>
                        <form action="#">
                            <div class="grid grid-cols-6 gap-6">
                                <!-- Empezar desde acá -->
                                <!-- Dirección de la empresa: Campos para dirección física, ciudad, estado/provincia, código postal y país.
 -->
                    ...
                    <div class="p-4 mb-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 dark:bg-gray-800">
                        <h3 class="mb-4 text-xl font-bold dark:text-white">Laravel TELESCOPE LARAVEL PULSE LARAVEL
                            HORIZON </h3>
                        <form action="#">
                            <div class="grid grid-cols-6 gap-6">
                                <!-- Empezar desde acá -->
                                <div class="inline-flex items-center">
                                    <a href="#"
                                        class="px-3 py-2 mb-3 mr-3 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-primary-300 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Telescope</a>
                                </div>
                                <div class="inline-flex items-center">
                                    <a href="#"
                                        class="px-3 py-2 mb-3 mr-3 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-primary-300 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Pulse</a>
                                </div>
                                <div class="inline-flex items-center">
                                    <a href="#"
                                        class="px-3 py-2 mb-3 mr-3 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-primary-300 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">HORIZON</a>
                                </div>
                    ...
                    <div class="p-4 mb-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 dark:bg-gray-800">
                        <h3 class="mb-4 text-xl font-bold dark:text-white">Integraciones</h3>
                        <form action="#">
                            <div class="">
                                <!-- Empezar desde acá -->
                                <h3> APIs externas: Configuración y gestión de integraciones con servicios externos
                                    (Google
                                    Analytics, CRM, etc.).
                                    Servicios de terceros: Opciones para habilitar/deshabilitar integraciones con
                                    servicios
                                    de terceros.</h3>
                    ...
                    <div class="p-4 mb-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 dark:bg-gray-800">
                        <h3 class="mb-4 text-xl font-bold dark:text-white">Tema fiscal</h3>
                        <form action="#">
                            <div class="">
                                <!-- Empezar desde acá -->
                                Impuestos etc
                    ...
                    <div class="p-4 mb-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 dark:bg-gray-800">
                        <h3 class="mb-4 text-xl font-bold dark:text-white">Politicas</h3>
                        <form action="#">
                            <div class="">
                                <!-- Empezar desde acá -->
                    ...
                    <div class="p-4 mb-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 dark:bg-gray-800">
                        <h3 class="mb-4 text-xl font-bold dark:text-white">Configuración de Apariencia</h3>
                        <form action="#">
                            <div class="">

                                Diseño del sitio web: Opciones para personalizar el diseño del sitio web, incluyendo
                                colores, fuentes y layout.
                                Temas: Configuración de diferentes temas o skins para el panel de administración y el
                                sitio web.
                                Logotipos y marcas: Gestión de diferentes versiones del logotipo y elementos de marca.
                    ...
                    <div class="p-4 mb-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 dark:bg-gray-800">
                        <h3 class="mb-4 text-xl font-bold dark:text-white">Proveedor de pagos</h3>
                        <form action="#">
                            <div class="">
                                culqi
                                stripe
            ...
            <div class="grid grid-cols-1 px-4 pt-2 xl:grid-cols-2 xl:gap-4">
                <div class="p-4 mb-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 dark:bg-gray-800 xl:mb-0">
                    <div class="flow-root">
                        ...
                        <p class="text-sm font-normal text-gray-500 dark:text-gray-400">Acá meter todas las
                            notificaciones que hay</p>
                        ...
                        <div class="divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <div class="flex items-center justify-between py-4">
                                <div class="flex flex-col flex-grow">
                                    ...
                                    <div class="text-base font-normal text-gray-500 dark:text-gray-400">Send an email
                                        reminding me to
                                        rate an item a week after purchase</div>
                                </div>
                            ...
                            <div class="flex items-center justify-between pt-4">
                                <div class="flex flex-col flex-grow">
                                    ...
                                    <div class="text-base font-normal text-gray-500 dark:text-gray-400">Send me an email
                                        when someone
                                        leaves a review with their rating</div>
                                </div>
