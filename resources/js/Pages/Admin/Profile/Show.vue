                        ...
                        <form action="#">
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-full">
                                    ...
                                    <div class="mb-1 text-sm font-normal text-gray-500 dark:text-gray-400">Ensure that
                                        these
                                        requirements are met:</div>
                                    <ul class="pl-4 space-y-1 text-gray-500 dark:text-gray-400">
                                        <li class="text-xs font-normal">At least 10 characters (and up to 100
                                            characters)</li>
                                        <li class="text-xs font-normal">At least one lowercase character</li>
                                        <li class="text-xs font-normal">Inclusion of at least one special character,
                                            e.g., ! @ # ?</li>
