...
<template>
    <AdminLayout title="SUNAT">
        ...
        <header>
            <nav>
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center justify-between lg:order-2">
                        ...
                        <!-- Dropdown menu -->
                        <div class="z-50 hidden w-56 my-4 text-base list-none bg-white divide-y divide-gray-100 shadow rounded-xl dark:bg-gray-700 dark:divide-gray-600"
                            id="dropdown">
                            <div class="px-4 py-3">
            ...
            <nav >
                <div class="flex flex-wrap items-center justify-between px-4 py-3 pb-5 md:pb-3">
                    <div class="flex items-center mb-2 md:mb-0">
                        <button id="dropdownUserNameButton" data-dropdown-toggle="dropdownUserName"
                            data-dropdown-placement="bottom"
                            class="flex items-center justify-between p-2 rounded-lg dark:bg-gray-700 dark:hover:bg-gray-800 hover:bg-gray-100 dark:hover-bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700"
                            type="button">
                            <span class="sr-only">Open user menu</span>
                            <div class="flex items-center mr-2">
                                <img src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/bonnie-green.png"
                                    class="mr-2 rounded-full w-7 h-7" alt="Bonnie avatar" />
                                <div class="text-left">
                        ...
                        <div id="dropdownUserName"
                            ...
                            <a href="#"
                                class="flex items-center px-4 py-3 rounded hover:bg-gray-50 dark:hover:bg-gray-600">
                                <div class="text-left">
                                    <div
                        ...
                        <button type="button" id="regionDropdownButton" data-dropdown-toggle="regionDropdown"
                            class="items-center p-2 pl-4 pr-3 text-sm font-medium text-gray-500 rounded-lg md:inline-flex hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-800 dark:text-gray-400 dark:hover:text-white focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600">
                            flowbite.com
                        </button>
                        <div id="regionDropdown"
                            class="z-30 hidden bg-white divide-y divide-gray-100 rounded shadow w-60 dark:bg-gray-700 dark:divide-gray-600">
                    ...
                    <div class="grid w-full grid-cols-2 gap-2 md:items-center md:flex md:w-auto">
                        <button type="button"
                        ...
                        <button id="moreOptionsDropdownButton" type="button" data-dropdown-toggle="moreOptionsDropdown"
                            ...
                            More
                            <svg class="ml-1.5 w-3.5 h-3.5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                                    d="M10 3a1 1 0 01.707.293l3 3a1 1 0 01-1.414 1.414L10 5.414 7.707 7.707a1 1 0 01-1.414-1.414l3-3A1 1 0 0110 3zm-3.707 9.293a1 1 0 011.414 0L10 14.586l2.293-2.293a1 1 0 011.414 1.414l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 010-1.414z"
                                    clip-rule="evenodd"></path>
                        ...
                        <div class="z-50 hidden w-48 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                            id="moreOptionsDropdown">
                            <ul class="py-1 text-gray-700 dark:text-gray-300"
                                aria-labelledby="moreOptionsDropdownButton">
                                <li>
                                    <a href="#"
                                        class="flex items-center px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white"><svg
                                            class="w-5 h-5 mr-2 text-gray-500 dark:text-gray-300" aria-hidden="true"
                                            fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd"
                                ...
                                <li>
                                    <a href="#"
                                        class="flex items-center px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white">
                                        <svg class="w-5 h-5 mr-2 text-gray-500 dark:text-gray-300" aria-hidden="true"
                                            fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path
            ...
            <nav class="p-3 bg-white shadow-sm lg:hidden dark:bg-gray-800">
        ...
        <nav
                class="hidden bg-white border-gray-200 shadow-sm dark:bg-gray-900 lg:block dark:border-gray-800">
                <div class="px-0 lg:px-6">
                    <div class="flex items-center">
                        <ul class="flex flex-col w-full mt-0 text-sm font-medium lg:flex-row">
                            <li class="block border-b dark:border-gray-700 lg:inline lg:border-b-0">
                                <a href="#"
                                    class="block px-4 py-3 text-gray-500 border-b-2 border-white dark:text-gray-400 hover:text-primary-600 dark:border-gray-900 dark:hover:text-primary-500 dark:hover:border-primary-500 hover:border-primary-600">Overview</a>
                            </li>
                            <li class="block border-b dark:border-gray-700 lg:inline lg:border-b-0">
                                <a href="#"
                                    class="block px-4 py-3 border-b-2 text-primary-600 hover:text-primary-600 dark:text-primary-500 dark:border-primary-500 border-primary-600"
        ...
        <div class="antialiased bg-gray-50 dark:bg-gray-900">
            ...
            <main class="grid flex-1 grid-cols-1 gap-5 p-4 dark:bg-gray-900 md:grid-cols-2">
                <div class="border-2 border-gray-300 border-dashed rounded-xl dark:border-gray-600 h-96"></div>
                <div class="border-2 border-gray-300 border-dashed rounded-xl dark:border-gray-600 h-96"></div>
                <div class="border-2 border-gray-300 border-dashed rounded-xl dark:border-gray-600 h-96"></div>
                <div class="border-2 border-gray-300 border-dashed rounded-xl dark:border-gray-600 h-96"></div>
                <div class="border-2 border-gray-300 border-dashed rounded-xl dark:border-gray-600 h-96"></div>
