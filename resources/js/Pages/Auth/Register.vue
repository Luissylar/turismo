    ...
    <section class="">
        <div class="grid lg:h-screen lg:grid-cols-2">
            <div class="flex items-center justify-center px-4 py-6 lg:py-0 sm:px-0">
                <form @submit.prevent="submit" class="max-w-md space-y-4 md:space-y-6 xl:max-w-xl">
                    ...
                    <div>
                        <InputLabel for="name" value="Nameasa" />
                        <TextInput id="name" v-model="form.name" type="text" class="block w-full mt-1 border bg-gray-50"
                            required placeholder="pepe" autofocus autocomplete="name" />
                    ...
                    <div v-if="$page.props.jetstream.hasTermsAndPrivacyPolicyFeature" class="mt-4">
                        <InputLabel for="terms" class="block text-sm font-medium text-gray-700">
                        ...
                        <Link :href="route('login')" class="text-sm text-indigo-600 underline hover:text-indigo-900">
                        Already registered?
                        </Link>
                    </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="px-5 text-center text-gray-500 dark:text-gray-400">o</div>
                        <div class="w-full h-0.5 bg-gray-200 dark:bg-gray-700"></div>
                    </div>
                ...
                <!-- <form @submit.prevent="submit">
                    ...
                    <h2 class="font-bold text-gray-900 dark:text-white">Inicia sesión con</h2>
